...
class Student:
    def __init__(self, root):
        ...
        current_course_frame = LabelFrame( left_frame, bd=2, bg="white", relief=RIDGE, text="Cureent Course Information",
                                font=("Calibri", 12, "bold"))
        current_course_frame .place(x=5, y=80, width=720, height=150)

        # Department labeling and combobox making
        depart_label = Label(current_course_frame,text="Department",font=('times new roman',13,'bold'),bg='white')
        depart_label.grid(row=0,column=0,padx=10)

        depart_combo_box=ttk.Combobox(current_course_frame,font=('times new roman',13,'bold'),state='readonly',width=20)
        depart_combo_box['value']=("select department",'Electrical Engineering ','Computer Engineering ','Architecture','Civil','BBA','Economics','Marketing','Law')
        ...
        course_combo_box = ttk.Combobox(current_course_frame, font=('times new roman', 13, 'bold'), state='readonly',
                                        width=20)
        ...
        year_combo_box = ttk.Combobox(current_course_frame, font=('times new roman', 13, 'bold'), state='readonly',
                                        width=20)
        ...
        semester_combo_box = ttk.Combobox(current_course_frame, font=('times new roman', 13, 'bold'), state='readonly',
                                        width=20)
        ...
        studentId_entry_field = ttk.Entry(student_information_frame,width=20,font=('times new roman', 13, 'bold'))
        studentId_entry_field.grid(row=0,column=1,padx=10,pady=5, sticky=W)

        # student name label and entry field
        student_name_label = Label(student_information_frame, text="Student Name", font=('times new roman', 13, 'bold'),
                                bg='white')
        student_name_label.grid(row=0, column=2, padx=10,pady=5, sticky=W)

        student_name_entry_field = ttk.Entry(student_information_frame, width=20, font=('times new roman', 13, 'bold'))
        student_name_entry_field.grid(row=0, column=3, padx=10,pady=5, sticky=W)

        # student section label and entry field
        student_section_label = Label(student_information_frame, text="Section", font=('times new roman', 13, 'bold'),
                                   bg='white')
        student_section_label.grid(row=1, column=0, padx=10, pady=5, sticky=W)

        student_section_entry_field = ttk.Entry(student_information_frame, width=20, font=('times new roman', 13, 'bold'))
        student_section_entry_field.grid(row=1, column=1, padx=10, pady=5, sticky=W)

        # student Gender label and entry field
        student_gender_label = Label(student_information_frame, text="Gender", font=('times new roman', 13, 'bold'),
                                   bg='white')
        student_gender_label.grid(row=1, column=2, padx=10, pady=5, sticky=W)

        student_gender_entry_field = ttk.Entry(student_information_frame, width=20, font=('times new roman', 13, 'bold'))
        student_gender_entry_field.grid(row=1, column=3, padx=10, pady=5, sticky=W)

        # student Date of birth label and entry field
        student_birthdate_label = Label(student_information_frame, text="Birth Date", font=('times new roman', 13, 'bold'),
                                      bg='white')
